...
public abstract class SpriterActor extends ShapeActor {
    ...
    private final DrawerProvider drawerProvider;

    public SpriterActor(Box2dWorld world, Vector2 spawn, boolean spawnIsLeftBottom, Entity entity, DrawerProvider drawerProvider) {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        drawerProvider.getDrawer().withBatch(batch).draw(player);
